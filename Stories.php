...
<html lang="en">
  <head>
    ...
    <title>Diet Recall : Stories</title>
    <!-- Favicon -->
    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->              
          <!-- TEXT BASED LOGO -->
          <a class="navbar-brand" href="index.html">DIET RECALL</a>              
          <!-- IMG BASED LOGO  -->
...
<!--
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li><a href="Plant Protein.html">Portfolio</a></li>
            <li class="dropdown active">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog <span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="blog-archive.html">Blog Archive</a></li>                
                <li><a href="Muscles.html">Blog Single with Left Sidebar</a></li>
                <li><a href="Terminolgies.html">Blog Single with Right Sidebar</a></li>
        ...
        <div class="row">
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="single-page-header-left">
              <h2>Stories</h2>
              <p><blockquote>"Make changes , not Excuses. Be Motivated Not Maniplulated. Work to Excel, Not Compete.
