...
<html lang="en">
  <head>
    ...
    <title>DIET RECALL : Plant Protein</title>
    <!-- Favicon -->
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="single-page-header-left">
              <h2>Plant Proteins</h2>
                <p><blockquote>"There is absolutely no nutrient, no protein, no vitamin, no mineral that can't be obtained from plant-based diet"</blockquote>
              </p>
            </div>
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="blog-archive-left">
                  ...
                  <article class="blog-news-single">
                    ...
                    <div class="blog-news-details blog-single-details">
                      ...
                      <img src=assets/images/chart.png alt="Chart" width="950" height="800">
